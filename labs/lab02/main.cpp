...
int main() {
    ...
    RubberDuck lemon;
    DecoyDuck jake;
    MysteryDuck weirdGuy = MysteryDuck("a weird duck","honk");
    ...
    cout << "This" << " is " << jake.getDescription() << " who says " ;
    jake.performQuack();
    cout << endl;

    // Introduce a mystery duck
    cout << "This" << " is " << weirdGuy.getDescription() << " who says " ;
    weirdGuy.performQuack();
    cout << endl;
